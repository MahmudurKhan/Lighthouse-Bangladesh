                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" method="post" action="" role="form" id="add_event" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="textarea13" class="col-sm-2 control-label">Event Profile File</label>
                            <div class="col-sm-10">
                        ...
                        <div class="col-sm-12">
                            <input type="submit" value="Update Profile file of the event" class="btn btn-block btn-success"/>
                        </div>
                        <br><br>
                        <div class="col-sm-12">
                            <a class="btn btn-block btn-warning" href="<? echo base_url().'controlle/event_list/' ?>">Skip</a>
                        </div>
    ...
    $(document).ready(function() {
        ...
        $("#add_event").on('submit',function(e) {
            ...
            function uploadFile() {
                ...
                http = '<? echo base_url().'controlle/update_profile_file' ?>';
                xhr.open("POST", http);
