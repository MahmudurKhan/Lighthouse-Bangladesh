        ...
        $("#add_event").on('submit',function(e) {
            ...
            function uploadFile() {
                ...
                xhr.onreadystatechange = function()
                {
                    ...
                    {
                        window.location.replace('<? echo base_url().'controlle/add_leaflet_view/' ?>'+xhr.responseText);
                    }
                }
            ...
            if(($.trim($("#event_name").val()) != '') && ($.trim($("#short_des").code()) != '') && ($.trim($("#long_des").code()) != '') && ($.trim($("#start_date").val()) != '') && ($.trim($("#end_date").val()) != '') && ($.trim($("#start_time").val()) != '') && ($.trim($("#end_time").val()) != '')  && ($.trim($("#profile").code()) != '') && ($.trim($("#location").val()) != '') && (document.getElementById('userfile').files[0] != undefined))
            {
                uploadFile();
            }
            else
